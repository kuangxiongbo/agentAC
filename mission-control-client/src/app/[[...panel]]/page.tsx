...
export default function Home() {
  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden uppercase-none">
      ...
      {/* Left: Restore sidebar navigation */}
      <NavRail />
      ...
      {/* Global exec approval overlay preserved */}
      <ExecApprovalOverlay />
    </div>
  )
}
...
const ESSENTIAL_PANELS = new Set([
  'overview', 'agents', 'tasks', 'chat', 'activity', 'logs', 'settings', 'gateway-config',
])
