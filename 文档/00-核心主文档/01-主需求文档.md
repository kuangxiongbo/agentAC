...
| 适用产品版本 | 2.1.3 |
| 更新时间 | 2026-06-14 |
| 核心来源 | 历史 PRD、人工值守 PRD、架构设计、测试报告、2.0.3/2.0.4/2.0.5/2.1.1/2.1.2/2.1.3 release notes、当前代码实现 |
...
- 已安装托盘客户端自动下载、替换和提示闭环；发布验证必须在服务端新镜像部署后，通过真实 `/api/releases/edge-runtime-manifest` 下载 runtime，而不能只用本机临时 manifest 覆盖验证。
- 企业模式显式接管用户终端 Codex。
- 更细粒度的值守 Agent 策略。
- 授权平台能力包标准化。
