...
### 8.8 Edge Bridge bootstrap 重连保护（2.1.38）
...
2.1.38 起，Edge 将配置写入和 Bridge 生命周期解耦：
...
| V2.1 | 2026-07-08 | 2.1.38：增加 Edge Bridge bootstrap 重连保护，避免托盘重复同步配置导致生产 transcript RPC 超时 |
