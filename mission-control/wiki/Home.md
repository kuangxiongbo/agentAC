...
E-AgentCenter is an open-source dashboard for orchestrating AI agents: agents, tasks, costs, workflows, and gateway connectivity in one place.
...
- Agent: A worker connected to E-AgentCenter that executes tasks and reports status/usage.
